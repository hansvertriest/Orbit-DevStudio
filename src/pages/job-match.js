    ...
    <div className="container">
      <div className="row">
        <div className="col-12 col-md-6">
          <h3>Introductie</h3>
          <p>Ik had het geluk om geslecteerd te zijn voor Open Summer of Code 2020, een initiatief van Open Knowledge Belgium die studenten te werk stelt voor echte klanten.</p>
          <p>Het project waar ik aan meewerkte was in opdracht van Infrabel. Zij wouden graag een leuke ervaring creëren om meer awareness bij te brengen voor Infrabel en meer specifiek voor hun technische vacatures. Met deze briefing gingen we aan de slag en begonnen we te conceptualiseren. </p>
          <p>Het resultaat is een interactief verhaal waar de speler kan beslissen hoe het plot zich ontplooid. Het verhaal geeft meer informatie over Infrabel en daagt de speler uit door verschillende problemen voor te leggen. Op deze manier krijgt hij/zij een zicht op welke uitdagingen de technische medewerkers van Infrabel elke dag te wachten staan.</p>
