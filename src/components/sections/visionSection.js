        ...
        <div className="vision-section" id="vision">
            ...
            <div className="row">
                <div className="col-12 col-md-6 col-lg-4">
                    <h2>Uitdaging</h2>
                    <p>Als student weet en kan ik nog niet alles. Maar ik ben altijd bereid om nieuwe uitdagingen aan te gaan en nieuwe technologieën te leren. Helemaal up-to-date met de laatste ontwikkelingen vinden we samen de beste oplossing voor uw wensen.</p>
                </div>
                <div className="col-12 col-md-6 col-lg-4">
                    <h2>Samenwerking</h2>
                    <p>Jouw project bij Orbit DevStudio is een project dat we samen doen. Door een goede communicatie en regelmatige feedbackmomenten zorgen we ervoor dat het eindresultaat perfect is afgestemd op wat u als klant voor ogen hebt.</p>
                </div>
            </div>
            </div>
        </div>
